...
#2. All zipcodes where state=KY (Kentucky). You may return just the zipcode column, or all columns.
    ...
    split_list_zipcode_KY = split_list(combined_result_zipcodes_KY, 9)
...
#3. All zipcodes between 40000 and 41000
    ...
    range_zipcodes_split = split_list(range_zipcodes, 9)
...
#4. The TotalWages column where state=PA (Pennsylvania)
    ...
    pa_total_wages_split = split_list(pa_total_wages, 9)
